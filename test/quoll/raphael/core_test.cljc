...
(deftest prefixed-name-test
  (testing "Parsing prefixed names"
    (let [g (-> (new-generator)
      ...
      (is (= [\space (->Iri "ex" "cat" "http://ex.com/cat") g nil]
             (parse-prefixed-name' "ex:cat " g)))
      (is (= [\. (->Iri "ex" "cat" "http://ex.com/cat") g nil]
             (parse-prefixed-name' "ex:cat. " g)))
      (is (= [\space (->Iri "" "cat" "http://test.org/cat") g nil]
             (parse-prefixed-name' ":cat " g)))
      (is (= [\. (->Iri "" "cat" "http://test.org/cat") g nil]
             (parse-prefixed-name' ":cat. " g)))
      (is (= [\space (->Iri "a-b-c" "cat" "http://t1.org/cat") g nil]
             (parse-prefixed-name' "a-b-c:cat " g)))
      (is (= [\space (->Iri "a_b" "cat" "http://t2.org/cat") g nil]
             (parse-prefixed-name' "a_b:cat " g)))
      (is (= [\space (->Iri "a.b" "cat" "http://t3.org/cat") g nil]
...
(deftest number-test
  (testing "Parsing numeric literals"
    (is (= [:eof 123 nil nil] (parse-number' "123")))
    (is (= [\space 123 nil nil] (parse-number' "123 ")))
    (is (= [\space 0 nil nil] (parse-number' "0 ")))
    (is (= [\space 0.0 nil nil] (parse-number' "0. ")))
    (is (= [\space 0.234 nil nil] (parse-number' "0.234 ")))
    (is (= [\space 0.234 nil nil] (parse-number' ".234 ")))
    (is (= [\space 23.4 nil nil] (parse-number' "23.40 ")))
    (is (= [\space 234.0 nil nil] (parse-number' "234. ")))
    (is (= [:eof -123 nil nil] (parse-number' "-123")))
    (is (= [\space 123 nil nil] (parse-number' "+123 ")))
    (is (= [\space 0 nil nil] (parse-number' "+0 ")))
    (is (= [\space 0.0 nil nil] (parse-number' "-0. ")))
    ...
    (is (= [\space 23.4 nil nil] (parse-number' "+23.40 ")))
    (is (= [\space -234.0 nil nil] (parse-number' "-234. ")))
    (is (= [\space 23.4e2 nil nil] (parse-number' "23.4e2 ")))
    (is (= [\space 234.0e2 nil nil] (parse-number' "234.e2 ")))
    (is (= [\space -234.0e2 nil nil] (parse-number' "-234.e2 ")))
    (is (= [\space -23.4e2 nil nil] (parse-number' "-23.4e2 ")))
    (is (= [\space 0.234e12 nil nil] (parse-number' "+.234e12 ")))
    (is (= [\space 0.234e12 nil nil] (parse-number' ".234e12 ")))
    (is (= [\space 0.234e-12 nil nil] (parse-number' "+.234e-12 ")))
    (is (= [\space 0.234e12 nil nil] (parse-number' ".234e+12 ")))
